...
@section("content")
    ...
    <main class="my-12">
        <h1 class="font-dosis text-brown-500 text-4xl mb-8 font-bold">Cadastrar novo tipo de pet</h1>

        <div class="flex flex-col justify-center align-center p-6 rounded-xl shadow-[0_0_20px_#00000055] max-w-[400px] w-[95%] mx-auto">
            <h1 class="text-center font-red-hat text-xl mb-4">Cadastrar tipo de pet</h1>
        ...
        $("#btn-cadastrar").on("click", function (e) {
            $.ajax({
                ...
                success: function (res) {
                    showToastr("success", "Tipo de pet cadastrado", res.message);
