...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Dosis:wght@200..800&family=Red+Hat+Display:ital,wght@0,300..900;1,300..900&display=swap" rel="stylesheet">
    ...
    <!--<script src="https://kit.fontawesome.com/5195aedf8c.js" crossorigin="anonymous"></script>-->
...
<body class="min-h-screen lg:w-8/10 w-9/10 mx-auto">
    @yield('content')
    <script>
        toastr.options = {
            "closeButton": true,
        ...
        @if (session("toastr"))
            showToastr({{ session("toastr") }}, {{ session("title") }}, {{ session("message") }});
        @endif
    </script>
    @stack('script')
</body>
